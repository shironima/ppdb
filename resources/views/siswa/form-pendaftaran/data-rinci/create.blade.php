...
@section('title', 'Formulir Pendaftaran Data Rinci Calon Siswa')

@section('content')
<div class="container mt-4">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title">Formulir Pendaftaran Data Rinci Calon Siswa</h3>
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('data-rinci.store') }}" method="POST">
                @csrf
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_saudara" name="jumlah_saudara" min="0" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="alamat_sekolah_asal" name="alamat_sekolah_asal" rows="3" required></textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="tahun_lulus" class="form-label">Tahun Lulus</label>
                                    <input type="number" class="form-control" id="tahun_lulus" name="tahun_lulus" min="1000" max="{{ date('Y') }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
